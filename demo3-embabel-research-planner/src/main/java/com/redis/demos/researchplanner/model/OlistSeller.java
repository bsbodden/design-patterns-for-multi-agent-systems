...
public class OlistSeller {
    ...
    @TagIndexed private String city;
    @TagIndexed private String state;
    @Indexed(sortable = true) private Double avgRating;
    @Indexed(sortable = true) private Double onTimePct;
    @Indexed(sortable = true) private Integer totalOrders;
    @Indexed private Double delayAvgDays;
    @Indexed private Double returnRate;
    @Indexed(sortable = true) private Double revenueTotal;
    @TagIndexed private List<String> categories;
