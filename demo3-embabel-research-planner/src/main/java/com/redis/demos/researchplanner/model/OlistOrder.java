...
public class OlistOrder {
    ...
    @TagIndexed private String customerId;
    @TagIndexed private String status;
    @Indexed(sortable = true) private LocalDateTime purchaseTimestamp;
    @Indexed(sortable = true) private LocalDateTime deliveredTimestamp;
    @Indexed(sortable = true) private LocalDateTime estimatedDelivery;
    @Indexed private List<OrderItem> items;
    @Indexed private Payment payment;
    @Indexed private Review review;
    @Indexed(sortable = true) private Double orderValue;
